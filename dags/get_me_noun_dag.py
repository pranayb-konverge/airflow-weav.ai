...
# globle variables
output_file_path = Variable.get("output_file_path") # By default: "./dags/files/nouns.csv"
input_file_path = Variable.get("input_file_path") # By default: "./dags/files/example_text.txt"
